...
<div class="container" style="background-color: white;border-radius: 10px;box-shadow: 1px 2px 12px 12px silver;margin-bottom:2rem">
	<h4  style="text-align:center;">ثبت گزارش مفتیش</h4>
	<hr/>
	<div class="custom-modal-text text-left">

		<form role="form" method="post" enctype="multipart/form-data" action="{{ route('sector.report_auditor_add') }}" >
		@csrf
			<div class="row">
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="report_no" class="control-label"><span style="color:red;">*</span>نمبر مکتوب  گزارش:</label>
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="report_quality" class="control-label">کیفیت گزارش:</label>
						<select class="form-control"  id="report_quality" name="report_quality" >
							<option> </option>
