	...
	<div class="row">
      <div class="col-sm-12">
          <div class="card-box table-responsive" style="box-shadow: 1px 2px 12px 12px silver">
               <a href="{{ route('sector.report_source_add') }}" class="btn btn-primary btn-md waves-effect waves-light m-b-3"
                      >
                  <i class="md md-add"></i> ثبت کردن معلومات
                </a>   
                <div class="dropdown pull-right">
                  <a href="{{ route('sector.report_source_excel') }}" class="btn btn-success m-b-3">
                    <i class="glyphicon glyphicon-download"></i>
                  </a> 
                </div>    
              <h4 class="header-title m-t-0 m-b-30" style="text-align:center;">گزارشات مراجع</h4>
              <table id="datatable" class="table table-bordered  table-hover">
                ...
                <tr style="background-color:#435966;">
                  ...
                  <th style="text-align:center;color:#fff;">ولایت</th>
              ...
              <tr>
                ...
                <td>
                  @if(!empty($data->file))
                    <span>
                      <a href="{{ route('sector.report_source_download', $data->file) }}" class="btn btn-primary">
                ...
                <span style="margin-right: 7%;">
                      <a href="{{ route('sector.report_source_edit',$data->id) }}" class="btn btn-default">
                ...
                <td>
                <span style="margin-right: 7%;">
                  <a onclick="return confirm('آیا مطمئین هستید که حذف شود؟')" href="{{ route('sector.report_source_delete',$data->id) }}" class="btn btn-default">
