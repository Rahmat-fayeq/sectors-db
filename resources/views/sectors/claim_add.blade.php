...
<form role="form" method="post" enctype="multipart/form-data" action="{{ route('sector.claim_add') }}" >
@csrf
<div class="row">	
	<div class="col-md-6">
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<input type="text" id="subject" name="subject" class="form-control" value="{{ old('subject')}}" autocomplete="off"  />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
	...
	<div class="col-md-6">
		<div class="form-group">
			<label for="source" class="control-label"><span style="color:red">*</span>مرجع:</label>
	...
	<div class="col-md-12" style="border:1px solid red; padding: 12px;border-radius: 10px;">
		<div class="col-md-4">
			<input type="text" placeholder="نمبر مکتوب رد"  name="reject_no" class="form-control" value="{{ old('reject_no')}}" autocomplete="off"  />
		</div>
		<div class="col-md-4">
			<input type="text" placeholder="تاریخ مکتوب رد" name="reject_date" id="reject_date" data-targetselector="#reject_date" class="form-control textFieldWidth" data-mddatetimepicker="true" data-placement="bottom" value="{{ old('reject_date')}}" autocomplete="off">
		</div>
		<div class="col-md-4">
			<input type="text" placeholder="موضوع مکتوب رد" name="reject_subject" class="form-control" value="{{ old('reject_subject')}}" autocomplete="off"  />
		</div>
	</div>
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<input type="text" id="analyzed_no" name="analyzed_no" class="form-control" value="{{ old('analyzed_no')}}" autocomplete="off"  />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="claim_no" class="control-label">نمبر اعتراضیه:</label>
			<input type="text" id="claim_no" name="claim_no" class="form-control" value="{{ old('claim_no')}}" autocomplete="off"  />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="claim_date" class="control-label">تاریخ اعتراضیه:</label>
			<input type="text" id="claim_date" name="claim_date" data-targetselector="#claim_date" class="form-control textFieldWidth" data-mddatetimepicker="true" data-placement="bottom"  placeholder="Y/M/D" value="{{ old('claim_date')}}" autocomplete="off">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="claim_files" class="control-label">ضمیایم(تعداد اوراق):</label>
			<input type="number" id="claim_files" name="claim_files" class="form-control" value="{{ old('claim_files')}}" autocomplete="off"  />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="auditors" class="control-label">مفتیشین:</label>
			<textarea id="auditors" name="auditors" class="form-control">{{ old('auditors')}}</textarea>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="group_no" class="control-label">نمبر مکتوب به هیئت:</label>
			<input type="text" id="group_no" name="group_no" class="form-control" value="{{ old('group_no')}}" autocomplete="off"  />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="group_date" class="control-label">تاریخ مکتوب به هیئت:</label>
			<input type="text" id="group_date" name="group_date" data-targetselector="#group_date" class="form-control textFieldWidth" data-mddatetimepicker="true" data-placement="bottom"  placeholder="Y/M/D" value="{{ old('group_date')}}" autocomplete="off">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="group_recived_date" class="control-label">تاریخ دریافت گزارش از هیئت:</label>
			<input type="text" id="group_recived_date" name="group_recived_date" data-targetselector="#group_recived_date" class="form-control textFieldWidth" data-mddatetimepicker="true" data-placement="bottom"  placeholder="Y/M/D" value="{{ old('group_recived_date')}}" autocomplete="off">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="authority_date" class="control-label">تاریخ پیشنهاد به مقام:</label>
			<input type="text" id="authority_date" name="authority_date" data-targetselector="#authority_date" class="form-control textFieldWidth" data-mddatetimepicker="true" data-placement="bottom"  placeholder="Y/M/D" value="{{ old('authority_date')}}" autocomplete="off">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<textarea id="hukm" name="hukm" class="form-control">{{ old('hukm')}}</textarea>
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<input type="number" id="board_files" name="board_files" class="form-control" value="{{ old('board_files')}}" autocomplete="off"  />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<input type="text" id="send_no" name="send_no" class="form-control" value="{{ old('send_no')}}" autocomplete="off"  />
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
			<label for="send_date" class="control-label">تاریخ ابلاغ به مرجع:</label>
			<input type="text" id="send_date" name="send_date" data-targetselector="#send_date" class="form-control textFieldWidth" data-mddatetimepicker="true" data-placement="bottom"  placeholder="Y/M/D" value="{{ old('send_date')}}" autocomplete="off">
		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
