...
<div class="container" style="background-color: white;border-radius: 10px;">        
	<h4  style="text-align:center;">ویرایش گزارش مفتیش</h4>
	<hr/>
	<div class="custom-modal-text text-left">
	<form role="form" method="post" enctype="multipart/form-data" action="{{ route('sector.report_auditor_edit', $data['id']) }}" >
	@csrf
	<div class="row">			
		<div class="col-sm-6">
		...
		<div class="col-md-6">
			<div class="form-group">
				<label for="report_date" class="control-label"><span style="color:red;">*</span>تاریخ مکتوب گزارش:</label>
