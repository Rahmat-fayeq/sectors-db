	...
	<div class="row">
      <div class="col-sm-12">
          <div class="card-box table-responsive" style="box-shadow: 1px 2px 12px 12px silver">
             <a href="{{ route('sector.maktob_response_add') }}" class="btn btn-primary btn-md waves-effect waves-light m-b-3"
                    >
                <i class="md md-add"></i> ثبت کردن معلومات
              </a>   
              <div class="dropdown pull-right">
                <a href="{{ route('sector.maktob_response_excel') }}" class="btn btn-success m-b-3">
                  <i class="glyphicon glyphicon-download"></i>
                </a> 
              </div>   

              <h4 class="header-title m-t-0 m-b-30" style="text-align:center;">مکاتیب جواب</h4>
              <table id="datatable" class="table table-bordered  table-hover">
                ...
                <tr style="background-color:#435966;">
                  ...
                  <th style="text-align:center;color:#fff;"> نمبر صادره</th>
                  <th style="text-align:center;color:#fff;"> تاریخ صادره</th>
                  <th style="text-align:center;color:#fff;"> موضوع مکتوب</th>
                  <th style="text-align:center;color:#fff;">مرسل الیه</th>
              ...
              <tr>
                ...
                <span style="margin-right: 7%;">
                      <a href="{{ route('sector.maktob_response_edit',$data->id) }}" class="btn btn-default">
